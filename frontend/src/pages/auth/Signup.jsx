      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-8 sm:p-10">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="mt-6 text-2xl font-heading text-brand-navy">Create Account</h1>
            <p className="mt-1 text-sm text-brand-gray">Join MedCare today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-xs font-semibold text-brand-navy mb-1.5">Confirm Password</label>
              <input
                type={showPassword ? "text" : "password"}
          ...
          <p className="mt-6 text-center text-sm text-brand-gray">
            ...
            <Link to="/login" className="font-semibold text-brand-green hover:text-brand-green-dark">
              Login
            </Link>
          </p>
        </div>
